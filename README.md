...
* DSSP 2.2.1. Again, the version matters as the output format change
...
Configuration
-------------
Check config.ini and config_flipper.json for correct paths to executables. If necessary
try to provide absolute paths. 
